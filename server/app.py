...
"""
FastAPI application for the Research Paper Assistant Environment.

This module creates an HTTP server that exposes the ResearchAssistantEnvironment
...
try:
    ...
    from ..models import ResearchAction, ResearchObservation
    from .research_env import ResearchAssistantEnvironment
